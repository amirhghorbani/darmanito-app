...
const dropDiv = (
        <div className='header__dropmenu'>
            ...
            <div className="dropmenu__items">
                <h3>صفحه اصلی</h3>
                <ul>
                    <li><a href="">عضویت در داروخانه ها</a></li>
       ...
       return (
            <div className='header'>
                <div className='header__logos'>
                    <a href="#"><img src={Logo} alt='header' /></a>
                    <a onClick={this.iconchangeHandler} href="#"><img src={this.state.isClicked ? DropDown : DropUp } alt='header' /></a>
                </div>
