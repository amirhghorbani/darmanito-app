    ...
    <div className={styles.container}>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          ...
          <input type="text" name='id' style={errors.id ? borderDanger : null} ref={register({required : true})} />
          {errors.id  && (<p style={dangerStyle}>شماره معتبر نیست</p>)}
        </div>

        <div>
          <label>نام داروخانه / فروشگاه</label>
          <input type="text" name='storename' style={errors.storename ? borderDanger : null} ref={register({required : true})}  />
          {errors.storename && (<p style={dangerStyle}>نام معتبر نیست</p>)}
        </div>

        <div>
          <label>شماره داروخانه</label>
          <input type="text" name='phone' style={errors.phone ? borderDanger : null} ref={register({required : true})} />
          {errors.phone && (<p style={dangerStyle}>شماره معتبر نیست</p>)}
        </div>

        <div>
          <label>شهر</label>
          <input type="text" name='city' style={errors.city ? borderDanger : null} ref={register({required : true})} />
          {errors.city && (<p style={dangerStyle}>شهر معتبر نیست</p>)}
        </div>

        <div>
          <label>منطقه</label>
          <input type="text" name='area' style={errors.area ? borderDanger : null} ref={register({required : true})}/>
          {errors.area && (<p style={dangerStyle}>منطقه معتبر نیست</p>)}
        </div>

        <div style={{ flexGrow: "1", width: "100%" }}>
          <label>آدرس دقیق</label>
          <input style={{ width: "100%" }} type="text" name='address' style={errors.address ? borderDanger : null} ref={register({required : true})}/>
        ...
        <div>
          ...
          <div className={styles.check}>
            <div className={styles.daily} style={errors.time ? borderDanger : null}>
              <input
            ...
            <div className={styles.allday} style={errors.time ? borderDanger : null}>
              <input
                className={styles.radio}
                type="radio"
                value="شبانه روزی"
        ...
        <div>
            ...
            <div className={styles.hours}>
                <input type='text' name='begin' className={styles.firstTime} style={errors.begin ? borderDanger : null} ref={register({required : true})} />
                <input type='text' name='end' className={styles.secondTime} style={errors.end ? borderDanger : null} ref={register({required : true})} />
            </div>
        </div>
